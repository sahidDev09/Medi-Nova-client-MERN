const Promotions = () => {
  return (
    <div className=" grid md:grid-cols-3 gap-2">
      <div className="w-full px-4 py-3 bg-blue-100 rounded-md shadow-md dark:bg-gray-800">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Prioritize your health with our Womens Wellness Package. This offer
            includes a gynecological exam, mammogram, bone density test, and
            more. Take charge of your health and book your appointment today.
          </p>
        </div>

        <div>
          <div className="flex items-center mt-2 text-gray-700 dark:text-gray-200">
            <span>Apply coupon for 45% off:</span>
            <a
      ...
      <div className="w-full  px-4 py-3 bg-blue-100 rounded-md shadow-md dark:bg-gray-800">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Focus on your well-being with our Mens Health Package. This
            comprehensive package includes a prostate exam, cholesterol test,
            and other essential screenings tailored to mens health needs.
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center mt-2 text-gray-700 dark:text-gray-200">
            <span>Apply coupon for 45% off:</span>
            <a
              className="mx-2 text-blue-600 cursor-pointer dark:text-blue-400S hover:underline"
              role="link">
              MEN45
            </a>
          </div>
      ...
      <div className="w-full  px-4 py-3 bg-blue-100 rounded-md shadow-md dark:bg-gray-800">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Maintain your health in your golden years with our Senior Health
            Checkup package. This package includes a full physical exam, blood
            tests, vision and hearing tests, and more to ensure you stay in top
            shape.
          </p>
        </div>
